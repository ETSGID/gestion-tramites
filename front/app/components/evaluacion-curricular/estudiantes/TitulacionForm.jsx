...
export default class TitulacionForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
    ...
    return (
      <div className="cuerpo">
        <Grid container spacing={4}>
          <Grid item xs={12}>
            <h2>Solicitud de evaluación curricular por titulación</h2>
            <p>Compruebe sus datos y rellene el siguiente formulario para solicitar la evaluación curricular por titulación.</p>
          </Grid>
          <Grid item xs={6}>
            <div id="data">
