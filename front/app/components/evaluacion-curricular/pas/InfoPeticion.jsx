...
export default class InfoPeticion extends React.Component {
    ...
    render() {
        let denegado;
        if (estadosEvaluacionCurricular.NO_CUMPLE_REQUISITOS == this.props.peticion.estadoPeticion || estadosEvaluacionCurricular.EVALUACION_DENEGADA == this.props.peticion.estadoPeticion) {
